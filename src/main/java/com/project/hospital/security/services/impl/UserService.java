package com.project.hospital.security.services.impl;
...
import com.project.hospital.security.repositories.RoleRepository;
import com.project.hospital.security.repositories.UserRepository;
import com.project.hospital.security.services.interfaces.UserServiceInterface;
...
public class UserService implements UserServiceInterface, UserDetailsService {
    ...
    public void createDoctorUser(Doctor doctor) {
        ...
        this.saveUser(new User(null, doctor.getFullName(), username, password, new ArrayList<>()));
        this.addRoleToUser(username, "ROLE_DOCTOR");
    }
}
