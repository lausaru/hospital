package com.project.hospital.security.config;

import com.project.hospital.security.config.filters.CustomAuthenticationFilter;
import com.project.hospital.security.config.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(POST, "/medicine").hasAnyAuthority("ROLE_ADMIN")

                .requestMatchers(GET, "/patients").hasAnyAuthority("ROLE_ADMIN")
                ...
                .requestMatchers(GET, "/appointments/{doctorId}").hasAnyAuthority("ROLE_DOCTOR")
